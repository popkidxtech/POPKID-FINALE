...
zokou({
  ...
  if (!superUser) {
    return repondre("*This command is restricted to the bot owner. or POPKID XTECHowner* 💀,,idiot");
  }
...
zokou({
  ...
  // Check if the command is issued by the owner
  if (!superUser) {
    return repondre("*This command is restricted to the bot owner or POPKID XTECH owner.* 💀,,idiot");
  }
